...
class AudioManager {
    ...
    playTitleMusic() {
        // EDITOR_EMBED_MODE_TITLE_MUSIC_FIX_V1: ignore title music requests in embedded editor playtest mode.
        if (window.LEMMINGS_EMBEDDED_MODE?.disableTitleMusic || window.SMS_LEMMINGS_EDITOR_EMBEDDED) {
