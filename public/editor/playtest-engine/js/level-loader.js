class LevelLoader {
    ...
    async loadLevelInfo(levelName) {
        return this.loadINI(`bundled-levels/${levelName}.mlm.ini`);
    }

    async loadLevel(levelName) {
        const iniPath = `bundled-levels/${levelName}.mlm.ini`;
        const mlmPath = `bundled-levels/${levelName}.mlm`;
